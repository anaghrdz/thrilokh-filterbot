...
API_ID = int(environ.get('API_ID', '26607232'))
API_HASH = environ.get('API_HASH', '5b9991274515e2df72da56188afceace')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1490606614').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002343279607'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002174971976').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002298021124') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://theftwelve:YjZobhhqBYHF1FFY@cluster0.ibor9.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "thrilokhbot")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+yovI9oy1b3xkNjll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+tyw2eVqe0CNhNGU1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+tYDjdjgVwxI2ZmI1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/@WtFXOt')
